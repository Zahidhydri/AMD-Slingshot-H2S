    ...
    return (
        <div className={`relative bg-white rounded-2xl shadow-xl border border-gray-100 w-[340px] transition-all hover:shadow-2xl group focus-within:ring-2 focus-within:ring-cyan-500/20 focus-within:ring-offset-2 ${data.executing ? 'ring-4 ring-cyan-500 shadow-cyan-500/30' : ''}`}>
            ...
            <Handle
                ...
                className="!w-7 !h-7 !bg-cyan-500 border-[3px] border-white shadow-[0_0_10px_rgba(6,182,212,0.4)] rounded-xl hover:!bg-cyan-400 hover:scale-110 transition-all z-20 flex items-center justify-center after:content-[''] after:w-2 after:h-2 after:bg-white after:rounded-full"
            />
            ...
            <Handle
                ...
                isConnectable={isConnectable}
                className="!w-7 !h-7 !bg-indigo-500 border-[3px] border-white shadow-[0_0_10px_rgba(99,102,241,0.4)] rounded-xl hover:!bg-indigo-400 hover:scale-110 transition-all z-20 flex items-center justify-center after:content-[''] after:w-2 after:h-2 after:bg-white after:rounded-full"
            />
        </div>
    );
};
